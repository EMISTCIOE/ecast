...
export default function ResetPasswordPage() {
  ...
  const requestReset = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setMessage(
          "If the email exists, a reset link has been sent to your inbox. Please check your email."
        );
        setEmail("");
      } else {
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg
                          className="w-5 h-5 text-gray-400 group-focus-within:text-purple-400 transition-colors"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <input
                        className="w-full pl-12 pr-4 py-3 rounded-xl bg-gray-800/50 border border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all outline-none text-white placeholder-gray-500"
