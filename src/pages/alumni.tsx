...
export default function AlumniPage() {
  ...
  const getRankEmoji = (index: number) => {
    // Returns trophy icon SVG for different ranks
    return null; // Using visual styling instead
  };
    ...
    <>
      ...
      <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white min-h-screen">
        <div className="container mx-auto px-4 py-24">
          ...
          {/* Top 3 Table */}
          {topThree.length > 0 &&
          topThree.some((a) => a.blogs > 0 || a.research_papers > 0) ? (
                          ...
                          <td className="px-6 py-5">
                            <div className="space-y-1">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm text-gray-300">
                                  {alumni.research_papers} research
                                  {alumni.research_papers !== 1 ? "" : ""}
                                </span>
                              </div>
                            </div>
                          </td>
            ...
            <div className="mb-20 max-w-5xl mx-auto">
              <div className="bg-gray-800/50 backdrop-blur rounded-xl border border-gray-700 p-12 text-center">
                ...
                <p className="text-gray-500">
                  No alumni has released research or blogs yet. Be the first to
                  contribute!
                </p>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            {Object.keys(alumniByBatch)
              ...
              .map((batchYear) => {
                ...
                // Sort alumni alphabetically by full_name
